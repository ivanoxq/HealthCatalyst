...
var apiServiceStub = {
    GetRandomCatImage: function (imageUrl) {
        return of('c2FmYXNkZmFkc2Zhc2RmYXNkZg==', asyncScheduler);
    },
    GetRandomCatInfo: function () {
        var cat = [{
                breeds: [],
                id: '4ia',
...
describe('AppComponent', function () {
    ...
    it('should start search and show grid spinner', async(function () {
    ...
    it('should search for patient', async(function () {
        fixture.detectChanges();
        component.SearchPatient('a');
        fixture.whenStable().then(function () {
            searchServiceStub.GetPatients().subscribe(function (x) {
                var countFound = 0;
                x.forEach(function (p) {
                    testPatients.get().forEach(function (y) {
    ...
    it('should hide grid spinner end of search', async(function () {
        fixture.detectChanges();
    ...
    it('should add new patient', async(function () {
        fixture.detectChanges();
        ...
        fixture.whenStable().then(function () {
            setTimeout(function () {
                var btn = document.querySelector('button.btn-default');
    ...
    it('should add Random Patient', fakeAsync(function () {
        fixture.detectChanges();
