...
var FlexGridComponent = /** @class */ (function () {
    function FlexGridComponent(searchService) {
        this.searchService = searchService;
    }
    FlexGridComponent.prototype.ngOnInit = function () {
        this.$patients = this.searchService.PatientResults.asObservable();
    };
    FlexGridComponent.prototype.clickAdd = function () {
        this.ClickAddButton();
    };
    FlexGridComponent.prototype.clickGenerate = function () {
        this.GenerateRandom();
    };
    __decorate([
        Input(),
